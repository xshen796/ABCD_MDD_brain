...
# Settings
load('result/x.Supplementary_materials/YouthDepree_WM_FS_covMedication.RData')
...
png("Figs/SuppleInfo/covMedication_pANDy_report_depre_IM_bulk.png", width = 8, height = 5.6, units = 'in', res = 300)
Fig.total # Make plot
dev.off()
