...
tiff("Figs/SuppleInfo/covParentSymptoms_DS_IM_bypANDy.tiff", width = 9, height = 13, units = 'in', res = 300)
fig.DS # Make plot
dev.off()
...
tiff("Figs/SuppleInfo/covParentSymptoms_MDD_IM_bypANDy.tiff", width = 9, height = 13, units = 'in', res = 300)
fig.MDD # Make plot
dev.off()
