...
source('FUNs/PheWAS_style_beta_plot.R')
...
fig.p.DS=beta_plot(TargetResult=targetdata.p.depre,color_theme_usr='Shen',shape_sig=T,
           category.input=ls.category,sig_nominal=T,
           plot_title='Depressive symptoms (reported by caregivers)',y_lim=c(-0.065,0.065),
...
# Make the figure: a file printed at 'outputpath' and object returned as fig
fig.y.DS=beta_plot(TargetResult=targetdata.y.depre,color_theme_usr='Shen',shape_sig=T,
           category.input=ls.category,sig_nominal=T,
           plot_title='Depressive symptoms (reported by children)',y_lim=c(-0.065,0.065),
...
png("Figs/Depre_IM/Depre_IM_bypANDy_beta.png", width = 14, height = 16, units = 'in', res = 300)
fig.DS # Make plot
dev.off()
...
# Make the figure: a file printed at 'outputpath' and object returned as fig
fig.p.MDD=beta_plot(TargetResult=targetdata.p.depre,color_theme_usr='Shen',shape_sig=T,
                category.input=ls.category,sig_nominal=T,,y_lim=c(-0.055,0.055),
...
# Make the figure: a file printed at 'outputpath' and object returned as fig
fig.y.MDD=beta_plot(TargetResult=targetdata.y.depre,color_theme_usr='Shen',shape_sig=T,
                category.input=ls.category,sig_nominal=T,,y_lim=c(-0.055,0.055),
...
png("Figs/Depre_IM/MDD_IM_bypANDy_beta.png", width = 14, height = 16, units = 'in', res = 300)
fig.MDD # Make plot
dev.off()
