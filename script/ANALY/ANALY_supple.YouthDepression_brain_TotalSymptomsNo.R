...
# factors
ls.factor=colnames(targetdata)[grep('^KSADS.DSM.MDDseverity.Ever',colnames(targetdata))]
...
save(result.YouthDepre.bulk,result.YouthDepre.region.covWholeB,file='result/x.Supplementary_materials/YouthDepree_WM_FS_DSMsymptoms.RData')
