...
cd /exports/igmm/eddie/GenScotDepression/shen/SData/UKB/iv.ABCD/release2.0.1/FamilialRisk_PGRS_MDD/
...
#R CMD BATCH script/ANALY/ANALY_supple.YouthDepression_brain_unrelated.R
