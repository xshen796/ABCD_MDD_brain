...
save(result.YouthDepre.bulk.all,result.YouthDepre.bulk.qced,result.YouthDepre.region.covWholeB.all,result.YouthDepre.region.covWholeB.qced,file='result/x.Supplementary_materials/YouthDepree_QCcomparison_DTI.RData')
