...
ls.models$covs=paste0(c('interview_age','I(interview_age^2)','sex','fsqc_qu_motion','site_id_l','race_ethnicity','household_income','fam_highest_edu'),collapse='+')#,'recent_socialdprv',
...
save(result.YouthDepre.bulk,result.YouthDepre.region,result.YouthDepre.region.covWholeB,file='result/i.Main_result/YouthDepree_WM_subcor_FS_covIncomeEdu.RData')
