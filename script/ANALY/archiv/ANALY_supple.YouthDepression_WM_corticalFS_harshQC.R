...
QC.file$fail_issues_N=rowSums(QC.file>1,na.rm=T)
IM.dat$fail_issues_N=QC.file$fail_issues_N
...
IM.dat=filter(IM.dat,IM.dat$fail_issues_N==0)
...
save(result.YouthDepre.bulk,result.YouthDepre.region,result.YouthDepre.region.covWholeB,file='result/x.Supplementary_materials/YouthDepree_WM_subcor_FS_harshQC.RData')
