...
IM.dat=filter(IM.dat,QC.file$fail_issues_N==0)
...
save(result.famRisk.bulk,result.famRisk.region,result.famRisk.region.covWholeB,file='result/x.Supplementary_materials/FamRisk_WM_subcor_FS_harshQC.RData')
