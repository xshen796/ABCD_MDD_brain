...
ls.covs=c('interview_age','recent_socialdprv','household_income','fam_highest_edu','ASR_p_depression_DSM5','Parent_as')#,'household_income','ADHD_ever'
...
# Generate ASR scores for father and mother separately --------------------

targetdata$Parent_as[FAM.dat$Parent_as>2]=NA

targetdata$ASRDepre_bioMother=targetdata$ASR_p_depression_DSM5
targetdata$ASRDepre_bioMother[targetdata$Parent_as!=1]=NA
targetdata$ASRDepre_bioFather=targetdata$ASR_p_depression_DSM5
targetdata$ASRDepre_bioFather[targetdata$Parent_as!=2]=NA
targetdata$ASRDepre_bioParents=targetdata$ASR_p_depression_DSM5
targetdata$ASRDepre_bioParents[is.na(targetdata$Parent_as)]=NA
...
# factors
ls.factor=colnames(targetdata)[grep('^ASRDepre_bio',colnames(targetdata))]
...
save(result.YouthDepre.bulk,result.YouthDepre.region.covWholeB,file='result/x.Supplementary_materials//FAMrisk_asr_WM_FS.RData')
