...
save(result.YouthDepre.bulk,result.YouthDepre.region.covWholeB,file='result/x.Supplementary_materials//YouthDepree_WM_subcor_FS_covCBCLotherConditions.RData')
