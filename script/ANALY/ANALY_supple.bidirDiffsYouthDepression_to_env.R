...
targetdata$KSADS.Depressive_symptoms_ever.discrepancy=targetdata$KSADS.Depressive_symptoms_ever.p - targetdata$KSADS.Depressive_symptoms_ever.y
targetdata$KSADS.DS.p_over_y = targetdata$KSADS.Depressive_symptoms_ever.discrepancy
targetdata$KSADS.DS.p_over_y[targetdata$KSADS.DS.p_over_y<0]=NA
targetdata$KSADS.DS.y_over_p = -targetdata$KSADS.Depressive_symptoms_ever.discrepancy
targetdata$KSADS.DS.y_over_p[targetdata$KSADS.DS.y_over_p<0]=NA
...
ls.factor=c('KSADS.DS.p_over_y','KSADS.DS.y_over_p')
...
save(result,file='result/x.Supplementary_materials/bidirectDiffs_YouthDepression_envVariable.RData')
