...
ls.models$covs=paste0(c('interview_age','I(interview_age^2)','sex','fsqc_qu_motion','site_id_l','race_ethnicity','recent_socialdprv','ASR_p_depression_DSM5'),collapse='+')#,,'household_income','fam_highest_edu'
...
save(result.YouthDepre.bulk,result.YouthDepre.region.covWholeB,file='result/x.Supplementary_materials//YouthDepree_WM_subcor_FS_covParentDepre.RData')
