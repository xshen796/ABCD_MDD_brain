...
targetdata = tab.data[tab.data$src_subject_id %in% FAM.dat$src_subject_id,]
...
save(result.YouthDepre.bulk,result.YouthDepre.region.covWholeB,file='result/x.Supplementary_materials/YouthDepree_WM_subcor_FS_unrelated.RData')
